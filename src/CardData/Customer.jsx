  ...
  <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white font-serif py-4 px-6 md:px-8 lg:px-10 xl:px-12 text-center md:text-left">
    CUSTOMER PRIORITIES
        ...
        <p className="px-12 py-8">
          At its core, "Customer Priorities" ensures a seamless journey through
          a diverse array of dishes, ranging from luxury options to quick and
          healthy alternatives .The AI Assistant module introduces a unique
          approach to recipe exploration ,allowing users to effortlessly
          discover, customize, and cook dishes with detailed step-by-step
          guidance. With features like customizable ingredients, portion sizes,
          and spice levels, our platform tailors the cooking experience to
        ...
        <p className="px-12 py-8">
          ...
          well-being by offering insights into daily routines, BMI calculations,
          and calorie requirements.
        </p>
        <p className=" py-8 ml-36">
          On the B2Bfront, our restaurant-focused model caters to industry
          needs, streamlining operations from order and inventory management to
          analytics and invoicing. The inclusion of an AI F&B team and food
        ...
        <p className="px-12 py-8">
          ...
          providing not just recipes but a tailored and seamless experience that
          respects the individual preferences and priorities of our users, both
          on the consumer and business fronts
        </p>
        </div>
      </div>
      <Footer />
