...
export default function Modal() {
  ...
  return (
    <>
      <button
        className="bg-blue-700 text-white active:bg-blue-700 font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 text-xl"
        type="button"
